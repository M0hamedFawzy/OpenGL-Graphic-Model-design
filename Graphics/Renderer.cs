...
namespace Graphics
{
    class Renderer
    {
        ...
        public void Initialize()
        {
            ...
            sun = new Texture(projectPath + "\\Textures\\sun.jpg", 1);
            moon = new Texture(projectPath + "\\Textures\\moon.jpg", 2);
            sand = new Texture(projectPath + "\\Textures\\sand.jpg", 3);

            Gl.glClearColor(0.96f, 0.96f, 0.96f, 1);
            ...
            float[] vertices= { 
                ...
                //road
                  //polygon
                  -2f, -0.4f, -50f,   0.001f,0,0, //0
                  5f,  -0.4f, -50f,   0.001f,0,0,
                  5f,  -0.4f, 50f,    0.001f,0,0,
                  -2f, -0.4f, 50f,    0.001f,0,0,
            ...
            float[] sun_moon = {
              //sun
              //polygon
              -25f, 30f, -100f,     0,0,0,  0, 0,//0   
              -25f, 60f, -100f,    0,0,0,   1, 0,
              10f,  60f, -100f,     0,0,0,  1, 1,
              10f,  30f, -100f,      0,0,0, 0, 1,

              //moon
              //polygon
              -25f, -5f, -100f,    0,0,0,  0, 0,//
              -25f, -35f, -100f,   0,0,0,  1, 0,
              10f, -35f, -100f,    0,0,0,  1, 1,
              10f, -5f, -100f,    0,0,0,   0, 1,
            };
            ...
            float[] sandLand =
            {
                //land
             //polygon
               -100f, -0.45f, -100f,     0,0,0,  0, 0, //0
               100f, -0.45f, -100f,      0,0,0,  10, 0,
               100f, -0.45f, 100f,       0,0,0,  10, 10,
               -100f, -0.45f, 100f,      0,0,0,  0, 10,
              //------------------------------------------------------------//
            };

            veticesBufferID = GPU.GenerateBuffer(vertices);
            sun_moon_BufferID = GPU.GenerateBuffer(sun_moon);
            sandBufferID = GPU.GenerateBuffer(sandLand);
        ...
        public void Draw()
        {
            ...
            Gl.glBindBuffer(Gl.GL_ARRAY_BUFFER, veticesBufferID);
            ...
            Gl.glUniformMatrix4fv(ShaderModelMatrixID, 1, Gl.GL_FALSE, new mat4(1).to_array());
            Gl.glDrawArrays(Gl.GL_QUADS, 79, 4);  //garage side1

            Gl.glUniformMatrix4fv(ShaderModelMatrixID, 1, Gl.GL_FALSE, new mat4(1).to_array());
            Gl.glDrawArrays(Gl.GL_QUADS, 83, 4);  //garage side2

            Gl.glUniformMatrix4fv(ShaderModelMatrixID, 1, Gl.GL_FALSE, new mat4(1).to_array());
            Gl.glDrawArrays(Gl.GL_QUADS, 87, 4);  //garage side3

            Gl.glUniformMatrix4fv(ShaderModelMatrixID, 1, Gl.GL_FALSE, new mat4(1).to_array());
            Gl.glDrawArrays(Gl.GL_QUADS, 91, 4);  //garage side4

            Gl.glUniformMatrix4fv(ShaderModelMatrixID, 1, Gl.GL_FALSE, ModelMatrix3.to_array());
            Gl.glDrawArrays(Gl.GL_QUADS, 95, 4);  //garage door
            ...
            Gl.glBindBuffer(Gl.GL_ARRAY_BUFFER, sun_moon_BufferID);
            Gl.glUniformMatrix4fv(ShaderModelMatrixID, 1, Gl.GL_FALSE, ModelMatrix.to_array());
            Gl.glEnableVertexAttribArray(0);
            ...
            sun.Bind();
            Gl.glDrawArrays(Gl.GL_QUADS, 0, 4);  //sun
            moon.Bind();
            Gl.glDrawArrays(Gl.GL_QUADS, 4, 4);  //moon
            ...
            Gl.glBindBuffer(Gl.GL_ARRAY_BUFFER, sandBufferID);
            Gl.glUniformMatrix4fv(ShaderModelMatrixID, 1, Gl.GL_FALSE, new mat4(1).to_array());
            Gl.glEnableVertexAttribArray(0);
            Gl.glVertexAttribPointer(0, 3, Gl.GL_FLOAT, Gl.GL_FALSE, 8 * sizeof(float), (IntPtr)0);
            Gl.glEnableVertexAttribArray(1);
            ...
            Gl.glDrawArrays(Gl.GL_QUADS, 0, 4);  //Land
            Gl.glDisableVertexAttribArray(0);
            Gl.glDisableVertexAttribArray(1);
            Gl.glDisableVertexAttribArray(2);
        }
